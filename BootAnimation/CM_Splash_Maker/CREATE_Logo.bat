...
echo.9. Exit
echo.
choice /n /m "Select A Menu Number:" /C:12345679
...
if exist "stock\%device_name%\3.png" bin\ffmpeg.exe -hide_banner -loglevel quiet -i stock\%device_name%\3.png -f rawvideo -vcodec rawvideo -pix_fmt bgr24 -y "temp\pic3.raw" > NUL
